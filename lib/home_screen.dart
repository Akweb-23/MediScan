...
import 'package:mediscanai/screens/all_categories_screen.dart'; // Make sure this path is correct
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'To access the service must be resolved track your location',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildUploadButton(),
                  const SizedBox(height: 20),
                  // Row for the "Categories" title and "View all" button
                  Row(
          ...
          children: List.generate(3, (index) {
            return AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: _promoCurrentPage == index ? Colors.cyan : Colors.grey[300],
    ...
    return BottomAppBar(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(icon: Icons.chat_bubble_outline, label: 'AI Chat'),
          const SizedBox(width: 40), // The space for the FAB
          _buildNavItem(icon: Icons.person_pin_circle_outlined, label: 'Profile'),
